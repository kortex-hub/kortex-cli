	...
	tests := []struct {
		...
		},
		{
			...
			exampleCmd: ExampleCommand{
				...
				Binary: "kortex-cli",
				Args:   []string{"workspace", "list"},
				Flags:  map[string]string{"f": "json"},
			},
			wantErr: false,
		},
		{
			...
			exampleCmd: ExampleCommand{
				...
				Binary: "kortex-cli",
				Args:   []string{"init"},
				Flags:  map[string]string{"storage": "/tmp/storage"},
			},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			exampleCmd: ExampleCommand{
				...
				Binary: "kortex-cli",
				Args:   []string{"init"},
				Flags:  map[string]string{"nonexistent-flag": "value"},
			},
			wantErr: true,
		},
		{
			...
			exampleCmd: ExampleCommand{
				...
				Binary: "kortex-cli",
				Args:   []string{"init"},
				Flags:  map[string]string{"name": "test", "verbose": ""},
			},
			wantErr: false,
		},
	}
